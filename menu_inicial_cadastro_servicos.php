		        ...
		        <ul class="navbar-nav ">
		            ...
		            <li class="nav-item">
                      ...
                      <div class="dropdown-menu ">
                            <a href="" class="dropdown-item"><i class="fa-solid fa-user"></i>Serviços</a>
                            <a href="" class="dropdown-item"><i class="fa-solid fa-house"></i>Funcionarios</a>                      
                      </div>
		            </li>
                    ...
                    <li class="nav-item">
                      ...
                      <div class="dropdown-menu ">
                            <a href="menu_inicial_cadastro_servicos.php" class="dropdown-item"><i class="fa-solid fa-user"></i>Serviços</a>
                            <a href="menu_inicial_cadastro_profissionais.php" class="dropdown-item"><i class="fa-solid fa-house"></i>Funcionarios</a>                      
                      </div>
		            </li>
                    <li class="nav-item" >
                ...
                <div class="col-10 caixa-funcionamento">
                      ...
                      <form action="#" method="POST">
                        ...
                        <div class="mb-3 espacamento-cadastro-funcionario">
                            ...
                            <select type="text" name="nome" class="form-control">
                            <?php
                                ...
                                if ($qtdProfissional > 0){
                                    while($row = $resProfissional->fetch_object()){
                                        print "<tr>";
                                        print"<option value=".$row->CodProfissional.">".$row->NomeProfissional."</option>";
                                    }
