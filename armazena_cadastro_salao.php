<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlSelect = "SELECT * FROM usuarios_salao WHERE cnpjSalao = '{$salao->cnpj}'";
    ...
    if($usuarios_existentes->num_rows > 0){
      ...
      $sql = "INSERT INTO usuarios_salao (nomeSalao, senhaSalao, cnpjSalao, emailSalao) VALUES ('$salao->nome', '$salao->senha', '$salao->cnpj', '$salao->email')";
