<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($email_existentes->num_rows > 0){
      ...
      $sql = "INSERT INTO salao (NomeFantasiaSalao, CNPJ_Salao) VALUES ('$salao->nome', '$salao->cnpj'); INSERT INTO usuario (SenhaUsuario, EmailUsuario) VALUES ('{$salao->senha}','{$salao->email}')";
