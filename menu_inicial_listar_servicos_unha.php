...
<div id="corpo-menu-inicial" > 
    ...
    <!-- INICIO SERVIÇOS -->
      ...
      <div class="col-12 conteudo-titulo-funcionamento">
            <h1><a class='btn btn-voltar' href="menu_inicial.php"><i class="fa-solid fa-arrow-left-long"></i></a>Salões com especialidade em unha </h1>
      </div>     
      ...
      <div class="col-12"> 
        ...
        <div class="row  justify-content-md-center">
            <div class="col-10 caixa-funcionamento-listar">
                   ...
                   $sqlServicoUnha = "SELECT DISTINCT id_Salao, TipoServico FROM servico WHERE TipoServico = '". 'unha' ."'";
                   $resServicoUnha = $conn->query($sqlServicoUnha);
                   $qtdServicoUnha = $resServicoUnha-> num_rows;
                   ...
                   if($qtdServicoUnha > 0){
                    ...
                    print "<th>Ações</th>";
                    print "<tr>";
                    while($row = $resServicoUnha->fetch_object()){
