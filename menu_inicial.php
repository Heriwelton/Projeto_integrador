<?php
    ...
    $sql3 = "SELECT idCliente as usuarioID from usuarios_cliente WHERE cpfCliente = '" . $_SESSION["usuario"] . "'"; //seleciona o nome do usuario de acordo com o cpf
    $con3 = $conn->query($sql3) or die($mysqli->error);
    $dadoID = $con3->fetch_array();
    if($dadoID["usuarioID"] == true){
        $_SESSION["idCliente"] = $dadoID["usuarioID"];
    }
        ...
        <div id="menu-navegacao"> 
		  <nav class=" navbar navbar-expand-md navbar-dark fixed-top navbar-transparente d-flex">
		     ...
		     <div class="collapse navbar-collapse" id="navegacao">
                ...
                <div class=" d-lg-block msg-recepcao">
                    <li>
                        seja bem vindo 
      		...
      		<div class="col-md-12">
				<div class="card-body font-weight-bold">
                    ...
                    <?php 
                        ...
                        $sql2 = "SELECT * from usuarios_cliente WHERE cpfCliente = '" . $_SESSION["usuario"] . "'";
					...
					<form action="editarCadastroCliente.php" method="post" >
						...
						<div class="form-group">           
							<label>Nome</label>
							<input name="nome" type="text" value="<?php echo $dados["nomeCliente"]; ?>" class="form-control">
						</div>
						...
						<div class="form-group">
							<label>CPF</label>
							<input name="cpf" type="text" value="<?php echo $dados["cpfCliente"]; ?>" class="form-control">
						</div>

                        <div class="form-group">
							<label>E-mail</label>
							<input name="email" type="text" value="<?php echo $dados["emailCliente"]; ?>" class="form-control">
						</div>
