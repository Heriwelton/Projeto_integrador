...
<div id="corpo-menu-inicial" > 
    ...
    <!-- INICIO SERVIÇOS -->
      ...
      <div class="col-12 conteudo-titulo-funcionamento">
            <h1><a class='btn btn-voltar' href="menu_inicial.php"><i class="fa-solid fa-arrow-left-long"></i></a>Salões com especialidade em maquiagem </h1>
      </div>     
      ...
      <div class="col-12"> 
        ...
        <div class="row  justify-content-md-center">
            <div class="col-10 caixa-funcionamento-listar">
                   ...
                   $sqlServicoMaquiagem = "SELECT DISTINCT id_Salao, TipoServico FROM servico WHERE TipoServico = '". 'maquiagem' ."'";
                   $resServicoMaquiagem = $conn->query($sqlServicoMaquiagem);
                   $qtdServicoMaquiagem = $resServicoMaquiagem-> num_rows;

                   

                   if($qtdServicoMaquiagem > 0){
                    ...
                    print "<th>Ações</th>";
                    print "<tr>";
                    while($row = $resServicoMaquiagem->fetch_object()){
