...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO cliente (nomeCliente, CPF_cliente) VALUES ('{$cliente->nome}','{$cliente->cpf}'); INSERT INTO usuario (SenhaUsuario, EmailUsuario) VALUES ('{$cliente->senha}','{$cliente->email}')";
    $usuarios_app = mysqli_multi_query($conn, $sql);
