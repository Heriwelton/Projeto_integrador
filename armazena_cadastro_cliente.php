...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlSelect = "SELECT * FROM usuarios_cliente WHERE cpfCliente = '{$cliente->cpf}'";
    ...
    $sql = "INSERT INTO usuarios_cliente (nomeCliente, senhaCliente, cpfCliente, emailCliente ) VALUES ('{$cliente->nome}','{$cliente->senha}','{$cliente->cpf}','{$cliente->email}')";
