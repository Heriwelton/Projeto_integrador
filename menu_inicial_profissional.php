		        ...
		        <ul class="navbar-nav ">
		            ...
		            <li class="nav-item">
                      ...
                      <div class="dropdown-menu ">
                            <a href="" class="dropdown-item"><i class="fa-solid fa-user"></i>Custos</a>
                            <a href="menu_inicial_listar_profissional.php" class="dropdown-item"><i class="fa-solid fa-house"></i>Funcionarios</a>                      
                      </div>
		            </li>
                    ...
                    <li class="nav-item">
                      ...
                      <div class="dropdown-menu ">
                            <a href="menu_inicial_cadastro_servicos.php" class="dropdown-item"><i class="fa-solid fa-user"></i>Custos</a>
                            <a href="menu_inicial_cadastro_profissional.php" class="dropdown-item"><i class="fa-solid fa-house"></i>Funcionarios</a>                      
                      </div>
		            </li>
                    <li class="nav-item" >
